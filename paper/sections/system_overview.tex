...
During offline preparation, each target video collection is processed into
canonical frame metadata and precomputed retrieval artifacts, including dense
indexes for visual, contextual, and speech evidence and a lexical BM25 index.
...
SigLIP2 provides visual text--frame similarity, BGE-M3 provides dense
FrameContext and ASR evidence, and BM25 provides lexical matching over
frame-associated text. Optional reference images contribute additional
