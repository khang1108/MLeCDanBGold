...
% Light-mode categorical palette; text labels and shapes duplicate color cues.
...
% Keep figures and tables out of the four-page prose-and-equation body.
...
% TikZ vocabulary: labels and shapes duplicate every color cue.
\tikzset{
