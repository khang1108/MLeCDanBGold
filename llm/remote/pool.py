...
class InferenceClientPool:
    ...
    def readiness(self) -> InferenceReadiness:
        ...
        raise RuntimeError("no inference endpoint is ready") from (errors[-1] if errors else None)
    ...
    def _call(self, name: str, *args: Any, **kwargs: Any) -> Any:
        ...
        while len(attempted) < len(self.clients):
            ...
            with self._lock:
                candidates = [index for index in range(len(self.clients)) if index not in attempted]
