...
This module adapts RetrievalHttpClient into the TemporalSearchGateway protocol
and ImageSearchService API surface. It validates bounds locally, materializes
canonical results via Corpus, and preserves canonical identity invariants.
"""
...
class RemoteTemporalSearchService:
    """Delegate temporal retrieval and scoring to a remote retrieval service."""

    def __init__(self, corpus: Corpus, client: RetrievalHttpClient) -> None:
        """Bind canonical corpus and remote HTTP client."""
        self.corpus = corpus
        self.client = client
    ...
    def search(
        ...
        *,
        ...
        """Search ordered event queries over remote retrieval service."""
        if top_k <= 0:
...
class RemoteImageSearchService:
    ...
    def __init__(
        self,
        corpus: Corpus,
        client: RetrievalHttpClient,
        *,
        max_upload_bytes: int,
        max_pixels: int,
    ) -> None:
        """Bind canonical corpus, HTTP client, and upload bounds."""
