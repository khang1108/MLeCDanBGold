...
from offline.ingestion.custom_pipeline.asr import ASRReuseBundle, require_asr_video_coverage
...
from offline.ingestion.custom_pipeline.disk import DiskSnapshot, snapshot_disk
from offline.ingestion.custom_pipeline.finalize import finalize_corpus
from offline.ingestion.custom_pipeline.shards import build_batch_index_bundle, split_batch_artifacts_by_video, write_video_shard
...
def _reload_inventory_from_manifest(archive_active_root: Path) -> ArchiveInventory:
    ...
    from offline.ingestion.custom_pipeline.archive import ArchiveMember
...
def finalize_pipeline(
    ...
    *,
    ...
    Delegates entirely to :func:`offline.ingestion.custom_pipeline.finalize.finalize_corpus`.
    """
