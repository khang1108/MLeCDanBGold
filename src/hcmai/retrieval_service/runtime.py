...
This module owns the heavy retrieval components loaded once in the gRPC
retrieval process: canonical Corpus, FAISS/vector indexes, BM25, query
encoders, temporal alignment, and direct image search. It does not expose
HTTP routes or handle FastAPI requests.
"""
...
class RetrievalRuntime:
    """Heavy retrieval composition facade serving gRPC requests."""
