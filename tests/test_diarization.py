...
import hcmai.transcripts.diarization as diarization_module
from hcmai.common.config import DiarizationConfig
from hcmai.common.schemas import TranscriptSegment
from hcmai.transcripts import DiarizationEngine
...
def test_diarization_lazy_load_and_overlap(
    ...
    engine = DiarizationEngine(config, hf_token="secret")
    segments = [
        TranscriptSegment(
