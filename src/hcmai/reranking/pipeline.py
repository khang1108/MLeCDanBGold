...
from hcmai.reranking.config import QwenRerankerConfig, RerankerConfig
from hcmai.reranking.models import HostedRerankingAdapter, RerankingAdapter
...
class RerankingService:
    ...
    def create_qwen_adapter(
        ...
        from hcmai.reranking.adapters.qwen import QwenAdapter
