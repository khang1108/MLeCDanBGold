...
class EnrichmentService:
    ...
    def build_frame_context(
        ...
        *,
        ...
        # Keep caption/OCR CLI imports lightweight; FrameContext's optional
        # PyArrow dependency is needed only when this stage is explicitly run.
    ...
    def run_caption_cli() -> int:
        ...
        from offline.enrichment.caption.generator import main
