...
from hcmai.embedding.artifacts import EmbeddingArtifactBuilder
from hcmai.embedding.models.contracts import (
    ImageEmbeddingAdapter,
    TextEmbeddingAdapter,
)
from hcmai.embedding.models.artifacts import EmbeddingRun
...
class EmbeddingService:
    ...
    def create_text_adapter(config: EncoderConfig) -> TextEmbeddingAdapter:
        ...
        if config.backend == "bge_m3":
            from hcmai.embedding.adapters.bge import BGEAdapter

            return BGEAdapter(config)
        from hcmai.embedding.adapters.siglip import SigLIPAdapter
    ...
    def create_remote_adapter(
        ...
        from hcmai.embedding.adapters.remote import (
            EmbeddingClient,
